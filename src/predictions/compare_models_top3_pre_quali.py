...
def main():
    ...
    for tag, df in all_data.items():
        ...
        final_results[tag] = evaluate_models(X_train, X_test, y_train, y_test, X_full, y, MODEL_DIR, prefix=f"{tag}_top3_pre-quali")

    output_file = OUTPUT_DIR / "model_performance_top3_pre_quali.json"
